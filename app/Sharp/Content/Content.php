...
use Baum\Node;
use Dvlpp\Sharp\Repositories\SharpLanguageTrait;
/**
 * Content
 */
class Content extends Node
{
    ...
    public function hasManyContentMeta()
    {
        return $this->hasMany('ContentMeta', 'content_id', 'id');
    }

    public function morphManyTaxonomy()
    {
        return $this->morphMany('Taxonomy', 'taxonable');
    }
